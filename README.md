...
**Screenshot:** `horrorscreenshots/HorrorDataEX1.png`  
...
**Screenshot:** `horrorscreenshots/HorrorDataEX2.png`  
...
**Screenshot:** `horrorscreenshots/HorrorDataEX3.png`  
...
**Screenshot:** `horrorscreenshots/HorrorDataEX4.png`  
...
**Screenshot:** `horrorscreenshots/HorrorDataEX5.png`  
...
**Screenshot:** `horrorscreenshots/HorrorDataEX6.png`  
...
**Screenshot:** `horrorscreenshots/HorrorDataEX7.png`  
...
**Screenshot:** `horrorscreenshots/HorrorDataEX8.png`  
...
**Screenshot:** `horrorscreenshots/HorrorDataEX9.png`  
...
**Screenshot:** `horrorscreenshots/HorrorDataEX10.png`  
...
> Optional: If you want to run the project without the full Kaggle dataset, you can create a small sample CSV (`HorrorMoviesSample.csv`) containing 10–20 rows of representative data and load that instead.

---

## Portfolio Notes

- Each screenshot corresponds to a query in `HorrorMoviesAnalysis.sql`.  
- This project demonstrates **data exploration, aggregation, and insight extraction** using SQL.  
- Recruiters can see both **queries and results**, highlighting your technical skills.
